...
def load_data():
    return pd.read_csv('data/prepared/data.csv')
...
def main():
    ...
    model, train_losses, test_losses, X_test, y_test = train_model(dataset, params['num_epochs'],
                                                                   params['learning_rate'], params['test_size'])
    os.makedirs('results', exist_ok=True)
    output = os.path.join('results', 'model.pkl')
    output_losses_train = os.path.join('results', 'losses_train.csv')
    output_losses_test = os.path.join('results', 'losses_test.csv')
    output_X_test = os.path.join('results', 'X_test.pkl')
    output_y_test = os.path.join('results', 'y_test.pkl')
